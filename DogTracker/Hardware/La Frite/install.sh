...
MESH_ID="test"
MESH_FREQ="2437"
LAN_IP="10.10.165.1" # needs to be derrived from ipv6 that gets set on wlan the .165 is to be derrived from last half of the second. ex a5 = 165
LAN_NETMASK="255.255.255.0"
DHCP_RANGE_START="10.10.165.2"
DHCP_RANGE_END="10.10.165.2"
